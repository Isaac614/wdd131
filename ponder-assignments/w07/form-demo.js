...
function validateForm(event) {
  ...
  if (theForm.paymentMethod.value === "creditCard") {
    if (theForm.cardNumber.value !== "123412341234") {
      isvalid = false;
      errors.pussh("Invalid Credit Card Number");
    }
  }
...
function togglePaymentDetails(e) {
  ...
  const creditCardContainer = document.getElementById("card-input");
  const paypalContainer = document.getElementById("paypal-input");

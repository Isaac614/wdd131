...
// const hikeNames = getHikeNames(hikes);
...
function searchList(array, queryString) {
  ...
  function searchCallback(object) {
    ...
    object.tags.find((element) => element.includes(queryString)));
  }
}
...
function getHikeNames(hikeList) {
  let hikeNames = [];
...
// const simpleSort = searchList(simpleList, "b");
